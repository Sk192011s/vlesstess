// connect.ts
// This is the VLESS library code that was being deleted.
// By saving it in your own repo, it can no longer be 404'd.
  ...
  socket.onopen = async () => {
    ...
    socket.onmessage = (e) => {
      if (e.data instanceof ArrayBuffer) {
        ...
        // Handle text data if necessary, though VLESS usually uses binary
      }
    };
